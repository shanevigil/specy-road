...
Test-fixture roadmap validation uses the consumer-shaped sample tree under [`tests/fixtures/specy_road_dogfood/`](../tests/fixtures/specy_road_dogfood/). That tree is not the toolkit's own product roadmap.
