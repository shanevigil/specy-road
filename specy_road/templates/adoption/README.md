# Adoption snippets (not `init project`)

These files are **optional copy-paste stubs** for consumer application repositories. They are **not** copied by `specy-road init project` (that command only scaffolds `templates/project/`).
