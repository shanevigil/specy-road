...
When working **in the specy-road toolkit repository** (this repo), use the commands documented under **Supply-chain & dependency audits** in [`docs/contributor-guide.md`](contributor-guide.md#supply-chain--dependency-audits) instead of placeholders for install and CVE scanning.
