...
> **Reference implementation:** `mckee_ui` — a React 19 + FastAPI full-stack app developed entirely with AI assistance. Every pattern in this guide was battle-tested there first.
